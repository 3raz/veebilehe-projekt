...
camera.position.z = 10e-20;
camera.position.x = 10e-20;
...
function moveCamera() {
    if (direction.ArrowUp && camera.position.y>10e-20) {
            camera.position.y -= camera.position.y/16;
            camera.position.z -= camera.position.z/16;
            camera.position.x -= camera.position.x/16;
    }
